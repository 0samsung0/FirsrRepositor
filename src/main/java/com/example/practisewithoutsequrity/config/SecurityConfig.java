...
// Admin
       ...
       //Создание (задач)(машин)(локации)
       //Формирование поездки (отправка запросу пользователю, на согласие)(добавление на карте точку А и В)
       //Просмотр статуса поездки (динамическая шкала % выполнения)
       //Получения отчета, по истечению срока поздки
...
// User
       ...
       //Получение уведомления о готовности к командировке (согласие)(отказ)
       ...
       //Просмотр статуса командировки (динамическа шкала % выполнения)
